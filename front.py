...
def register_user():
    ...
    if response.status_code == 200:
        print("Registro exitoso. Iniciando sesión automáticamente...")
        ...
        if login_response.status_code == 200:
            ...
            print(data["message"])
            return data["user_id"]  # Devuelve el ID del usuario
        else:
            print("Error al iniciar sesión tras registro:", login_response.json().get("detail", "Error desconocido"))
            return None
    else:
